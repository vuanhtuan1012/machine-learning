...
% Compute activation units at layer 2
a1 = [ones(m, 1) X]; % add bias unit before computation
z2 = a1 * Theta1';
a2 = sigmoid(z2);

% Compute output units
a2 = [ones(m, 1) a2]; % add bias unit before computation
z3 = a2 * Theta2';
a3 = sigmoid(z3);
h = a3;
